...
//
const BotName = 'PtrLbs'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/moch_izky31/'; // Nama Instagramlu cok
const whatsapplu = '0838-0821-5556'; // Nomor whatsapplu cok
